...
# File: get_weapon_air_defend_dps_calc.pyc (Python 3.11)
...
calc = bp_attr_calc_obj.get_module_total_dps_calc(slot_id, module_id, common_definition.MA_SHIP_AIR_DPS)
return calc
