...
# File: get_weapon_destroy_coef_dps_calc.pyc (Python 3.11)
...
calc = bp_attr_calc_obj.get_module_total_dps_calc(slot_id, module_id, common_definition.MA_SHIP_DESTROY_COEF_DPS)
return calc
