"""dump系统强化/效果定义表——这是舰船属性数值(dph/HP/命中/抵抗)的真正来源

关键表：
- Tb_cfg_system_enhance / system_enhance_tree: 系统强化(战报techId→强化项)
- Tb_cfg_ship_system: 舰船系统定义
- Tb_cfg_effect_def / effect_param: 效果底层定义
- Tb_cfg_system_skill: 系统技能
"""
...
try {
    ...
    var pyCode = [
        ...
        "    dump_table('common.config.db.Tb_cfg_system_enhance', 'cfg_system_enhance.json')",
        "    dump_table('common.config.db.Tb_cfg_system_enhance_tree', 'cfg_system_enhance_tree.json')",
        "    dump_table('common.config.db.Tb_cfg_ship_system', 'cfg_ship_system.json')",
        "    dump_table('common.config.db.Tb_cfg_effect_def', 'cfg_effect_def.json')",
        "    dump_table('common.config.db.Tb_cfg_effect_param', 'cfg_effect_param.json')",
        "    dump_table('common.config.db.Tb_cfg_system_skill', 'cfg_system_skill.json')",
        "    dump_table('common.config.db.Tb_cfg_weapon_priority', 'cfg_weapon_priority.json')",
        "    dump_table('common.config.db.Tb_cfg_ship_blueprint_choice', 'cfg_ship_blueprint_choice.json')",
        "except Exception:",
