...
try {
    ...
    var pyCode = [
        ...
        "    out.append('bdm type='+str(type(bdm)))",
        "    attrs=[a for a in dir(bdm) if not a.startswith('__')]",
        "    scheme_attrs=[a for a in attrs if 'scheme' in a.lower() or 'code' in a.lower() or 'encode' in a.lower() or 'decode' in a.lower() or 'share' in a.lower()]",
        "    out.append('scheme相关: '+str(scheme_attrs))",
        "    # 列出所有方法名",
        "    out.append('全部方法(前40): '+str(attrs[:40]))",
        "except Exception:",
