...
try {
    ...
    var pyCode = [
        ...
        "    # 巅峰等级表(全局加成)",
        "    dump_table('common.config.db.Tb_cfg_ship_peak_level', 'cfg_ship_peak_level.json')",
        "    dump_table('common.config.db.Tb_cfg_blueprint_peak_level', 'cfg_blueprint_peak_level.json')",
        "    dump_table('common.config.db.Tb_cfg_bp_peak_level', 'cfg_bp_peak_level.json')",
        "    # 强化等级数值表(命中/伤害/冷却等各级数值)",
