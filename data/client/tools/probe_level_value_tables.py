"""探测并dump等级数值表：battle_effect_summary + 其他可能含等级数值的表"""
...
try {
    ...
    var pyCode = [
        ...
        "    # DESC_INDEX指向的数值表",
        "    dump_table('common.config.db.Tb_cfg_battle_effect_summary', 'cfg_battle_effect_summary.json')",
        "    # 强化等级数值表候选",
        "    dump_table('common.config.db.Tb_cfg_blueprint_additional_sys', 'cfg_blueprint_additional_sys.json')",
        "    dump_table('common.config.db.Tb_cfg_bp_research_tree_node', 'cfg_bp_research_tree_node.json')",
        "    dump_table('common.config.db.Tb_cfg_ship_bp_te_company_choice', 'cfg_ship_bp_te_company_choice.json')",
        "except Exception:",
