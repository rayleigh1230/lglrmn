...
try {
    ...
    var pyCode = "import importlib.util as _ilu\n" +
        "_spec = _ilu.spec_from_file_location('_probe_mod', '__PROBE_PATH__')\n" +
        "_mod = _ilu.module_from_spec(_spec)\n" +
        "_spec.loader.exec_module(_mod)\n" +
        "_probe_out = _mod.RESULT\n";
...
print("attach",pid[0],"...")
JS = JS_TEMPLATE.replace("__PROBE_PATH__", PROBE_PATH)
