 ...
 */
import type { Fleet, RNG } from '../types/index';
import type { SimEvent, AttackRecord, BattleReport } from '../types/events';
import { RuntimeFleet, RuntimeShip, RuntimeWeapon } from '../model/runtime';
import { Scheduler } from './scheduler';
import { selectTarget, aliveShips } from '../phases/target';
import { interceptCheck } from '../phases/intercept';
import { hitCheck } from '../phases/hit';
import { critCheck } from '../phases/crit';
import { damageCalc } from '../phases/damage';
